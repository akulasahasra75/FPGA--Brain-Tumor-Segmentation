...
// ==============================================================
`timescale 1ns/1ps
module otsu_threshold_top_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_RESULT_I_DATA_0 = 6'h18,
    ADDR_RESULT_I_DATA_1 = 6'h1c,
    ADDR_RESULT_I_DATA_2 = 6'h20,
    ADDR_RESULT_I_CTRL   = 6'h24,
    ADDR_RESULT_O_DATA_0 = 6'h28,
    ADDR_RESULT_O_DATA_1 = 6'h2c,
    ADDR_RESULT_O_DATA_2 = 6'h30,
    ADDR_RESULT_O_CTRL   = 6'h34,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
    WRRESET              = 2'd3,
