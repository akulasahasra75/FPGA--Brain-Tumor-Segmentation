...
reg   [21:0] sum_fu_40;
wire   [21:0] sum_1_fu_110_p2;
wire    ap_loop_init;
reg   [14:0] i_2_fu_44;
wire   [14:0] add_ln274_fu_87_p2;
reg   [14:0] ap_sig_allocacmp_i;
wire    ap_block_pp0_stage0_01001;
wire   [21:0] zext_ln277_fu_106_p1;
reg    ap_done_reg;
...
always @ (*) begin
    if (((icmp_ln274_fu_81_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        sum_out_ap_vld = 1'b1;
    end else begin
        sum_out_ap_vld = 1'b0;
    end
...
assign add_ln274_fu_87_p2 = (ap_sig_allocacmp_i + 15'd1);
...
assign icmp_ln274_fu_81_p2 = ((ap_sig_allocacmp_i == 15'd16384) ? 1'b1 : 1'b0);
