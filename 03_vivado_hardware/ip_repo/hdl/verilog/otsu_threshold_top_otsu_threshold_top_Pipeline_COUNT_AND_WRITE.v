...
module otsu_threshold_top_otsu_threshold_top_Pipeline_COUNT_AND_WRITE (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [63:0] img_out;
output  [13:0] local_out_address0;
...
reg   [0:0] icmp_ln687_reg_195;
reg    ap_block_pp0_stage0_11001;
reg    ap_block_pp0_stage0_11001_grp1;
reg   [7:0] px_reg_209;
wire   [63:0] zext_ln687_fu_143_p1;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [14:0] fg_fu_70;
wire   [14:0] fg_1_fu_165_p2;
wire    ap_block_pp0_stage0_grp0;
wire    ap_loop_init;
reg    ap_loop_exit_ready_pp0_iter1_reg;
reg   [14:0] i_fu_74;
wire   [14:0] add_ln687_fu_131_p2;
reg   [14:0] ap_sig_allocacmp_i_3;
wire    ap_block_pp0_stage0_01001_grp0;
reg    local_out_ce0_local;
wire   [0:0] icmp_ln691_fu_156_p2;
wire   [14:0] zext_ln691_fu_161_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln687_fu_125_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln687_fu_125_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_exit_ready_pp0_iter1_reg == 1'b1) & (icmp_ln687_reg_195 == 1'd1))) begin
        fg_out_ap_vld = 1'b1;
    end else begin
        fg_out_ap_vld = 1'b0;
    end
...
assign add_ln687_fu_131_p2 = (ap_sig_allocacmp_i_3 + 15'd1);
...
assign fg_1_fu_165_p2 = (zext_ln691_fu_161_p1 + fg_fu_70);

assign fg_out = fg_fu_70;

assign icmp_ln687_fu_125_p2 = ((ap_sig_allocacmp_i_3 == 15'd16384) ? 1'b1 : 1'b0);

assign icmp_ln691_fu_156_p2 = ((px_reg_209 != 8'd0) ? 1'b1 : 1'b0);

assign local_out_address0 = zext_ln687_fu_143_p1;
...
assign m_axi_gmem1_0_WDATA = px_reg_209;
...
assign zext_ln687_fu_143_p1 = ap_sig_allocacmp_i_3;

assign zext_ln691_fu_161_p1 = icmp_ln691_fu_156_p2;

endmodule //otsu_threshold_top_otsu_threshold_top_Pipeline_COUNT_AND_WRITE
