...
input  [7:0] zext_ln284;
output  [45:0] var_sum_out;
...
wire   [8:0] zext_ln284_cast_fu_78_p1;
reg   [8:0] zext_ln284_cast_reg_175;
...
wire   [63:0] zext_ln284_1_fu_107_p1;
wire    ap_block_pp0_stage0;
reg   [45:0] var_sum_fu_44;
wire   [45:0] var_sum_1_fu_145_p2;
wire    ap_loop_init;
reg   [14:0] i_fu_48;
wire   [14:0] add_ln284_fu_101_p2;
...
wire   [45:0] zext_ln288_fu_141_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        zext_ln284_cast_reg_175[7 : 0] <= zext_ln284_cast_fu_78_p1[7 : 0];
    end
end
...
always @ (*) begin
    if (((icmp_ln284_reg_180_pp0_iter1_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
assign add_ln284_fu_101_p2 = (ap_sig_allocacmp_i_2 + 15'd1);
...
assign diff_fu_121_p2 = (zext_ln287_fu_117_p1 - zext_ln284_cast_reg_175);

assign icmp_ln284_fu_95_p2 = ((ap_sig_allocacmp_i_2 == 15'd16384) ? 1'b1 : 1'b0);

assign local_in_address0 = zext_ln284_1_fu_107_p1;
...
assign zext_ln284_1_fu_107_p1 = ap_sig_allocacmp_i_2;

assign zext_ln284_cast_fu_78_p1 = zext_ln284;
...
always @ (posedge ap_clk) begin
    zext_ln284_cast_reg_175[8] <= 1'b0;
end
