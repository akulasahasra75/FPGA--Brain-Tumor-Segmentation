...
always @ (*) begin
    if (((icmp_ln261_reg_161 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln261_fu_95_p2 = (ap_sig_allocacmp_i + 15'd1);
...
assign icmp_ln261_fu_89_p2 = ((ap_sig_allocacmp_i == 15'd16384) ? 1'b1 : 1'b0);
