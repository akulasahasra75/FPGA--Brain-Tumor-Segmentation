...
wire   [0:0] icmp_ln243_fu_104_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg    gmem0_blk_n_R;
wire    ap_block_pp0_stage0;
reg   [14:0] i_3_reg_132;
reg    ap_block_pp0_stage0_11001;
reg   [14:0] i_3_reg_132_pp0_iter1_reg;
reg   [7:0] gmem0_addr_read_reg_146;
wire   [63:0] zext_ln243_fu_121_p1;
reg   [14:0] i_fu_58;
wire   [14:0] add_ln243_fu_110_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln243_fu_104_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln243_fu_104_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln243_fu_110_p2 = (ap_sig_allocacmp_i_3 + 15'd1);
...
assign icmp_ln243_fu_104_p2 = ((ap_sig_allocacmp_i_3 == 15'd16384) ? 1'b1 : 1'b0);

assign local_in_address1 = zext_ln243_fu_121_p1;

assign local_in_d1 = gmem0_addr_read_reg_146;
