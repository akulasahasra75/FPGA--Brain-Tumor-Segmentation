...
module otsu_threshold_top_otsu_threshold_top_Pipeline_READ_IN (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [63:0] img_in;
output  [13:0] local_in_address1;
output   local_in_ce1;
output   local_in_we1;
output  [7:0] local_in_d1;
...
wire   [0:0] icmp_ln594_fu_102_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg    gmem0_blk_n_R;
wire    ap_block_pp0_stage0_grp1;
reg   [14:0] i_2_reg_136;
reg    ap_block_pp0_stage0_11001;
reg   [14:0] i_2_reg_136_pp0_iter1_reg;
reg    ap_block_pp0_stage0_11001_grp1;
reg   [7:0] gmem0_addr_read_reg_150;
wire   [63:0] zext_ln594_fu_125_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [14:0] i_fu_62;
wire   [14:0] add_ln594_fu_108_p2;
wire    ap_loop_init;
reg   [14:0] ap_sig_allocacmp_i_2;
wire    ap_block_pp0_stage0;
reg    local_in_we1_local;
wire    ap_block_pp0_stage0_11001_grp0;
reg    ap_block_pp0_stage0_subdone_grp0_done_reg;
wire    ap_block_pp0_stage0_subdone_grp0;
reg    local_in_ce1_local;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln594_fu_102_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln594_fu_102_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        local_in_ce1_local = 1'b1;
    end else begin
        local_in_ce1_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        local_in_we1_local = 1'b1;
    end else begin
        local_in_we1_local = 1'b0;
    end
end
...
assign add_ln594_fu_108_p2 = (ap_sig_allocacmp_i_2 + 15'd1);
...
assign icmp_ln594_fu_102_p2 = ((ap_sig_allocacmp_i_2 == 15'd16384) ? 1'b1 : 1'b0);

assign local_in_address1 = zext_ln594_fu_125_p1;

assign local_in_ce1 = local_in_ce1_local;

assign local_in_d1 = gmem0_addr_read_reg_150;

assign local_in_we1 = local_in_we1_local;
...
assign zext_ln594_fu_125_p1 = i_2_reg_136_pp0_iter1_reg;
