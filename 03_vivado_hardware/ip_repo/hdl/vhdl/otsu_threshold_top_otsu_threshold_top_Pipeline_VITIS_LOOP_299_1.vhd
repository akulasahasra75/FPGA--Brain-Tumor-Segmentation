...
entity otsu_threshold_top_otsu_threshold_top_Pipeline_VITIS_LOOP_299_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of otsu_threshold_top_otsu_threshold_top_Pipeline_VITIS_LOOP_299_1 is 
...
attribute shreg_extract : string;
    ...
    signal trunc_ln302_fu_84_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal trunc_ln302_reg_195 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal zext_ln302_fu_131_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_s_1 : STD_LOGIC_VECTOR (31 downto 0);
    signal iter_fu_48 : STD_LOGIC_VECTOR (3 downto 0) := "0000";
    signal trunc_ln299_fu_141_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal s_2_fu_124_p3 : STD_LOGIC_VECTOR (30 downto 0);
    signal grp_fu_78_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln301_fu_88_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln301_fu_110_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln302_fu_113_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln302_fu_118_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln296_fu_106_p1 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                ...
                iter_fu_48 <= trunc_ln299_fu_141_p1;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                ...
                trunc_ln302_reg_195 <= trunc_ln302_fu_84_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state36)) then
                s_new_reg_200 <= add_ln301_fu_88_p2(31 downto 1);
            end if;
        end if;
    end process;
    ...
    add_ln301_fu_88_p2 <= std_logic_vector(unsigned(grp_fu_78_p2) + unsigned(s_1_reg_188));
    ...
    icmp_ln302_fu_113_p2 <= "1" when (unsigned(zext_ln301_fu_110_p1) < unsigned(s_1_reg_188)) else "0";
    iter_3_fu_135_p2 <= std_logic_vector(unsigned(zext_ln296_fu_106_p1) + unsigned(ap_const_lv5_1));
    or_cond_demorgan_fu_153_p2 <= (xor_ln302_fu_118_p2 or tmp_fu_145_p3);
    s_2_fu_124_p3 <= 
        trunc_ln302_reg_195 when (xor_ln302_fu_118_p2(0) = '1') else 
        s_new_reg_200;
    ...
    trunc_ln299_fu_141_p1 <= iter_3_fu_135_p2(4 - 1 downto 0);
    trunc_ln302_fu_84_p1 <= ap_sig_allocacmp_s_1(31 - 1 downto 0);
    xor_ln302_fu_118_p2 <= (icmp_ln302_fu_113_p2 xor ap_const_lv1_1);
    zext_ln296_fu_106_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(iter_fu_48),5));
    zext_ln301_fu_110_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(s_new_reg_200),32));
    zext_ln302_fu_131_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(s_2_fu_124_p3),32));
end behav;
