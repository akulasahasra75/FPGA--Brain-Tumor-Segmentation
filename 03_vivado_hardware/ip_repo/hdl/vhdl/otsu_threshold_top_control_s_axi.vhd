...
entity otsu_threshold_top_control_s_axi is
generic (
...
architecture behave of otsu_threshold_top_control_s_axi is
    ...
    constant ADDR_RESULT_I_DATA_0 : INTEGER := 16#18#;
    constant ADDR_RESULT_I_DATA_1 : INTEGER := 16#1c#;
    constant ADDR_RESULT_I_DATA_2 : INTEGER := 16#20#;
    constant ADDR_RESULT_I_CTRL   : INTEGER := 16#24#;
    constant ADDR_RESULT_O_DATA_0 : INTEGER := 16#28#;
    constant ADDR_RESULT_O_DATA_1 : INTEGER := 16#2c#;
    constant ADDR_RESULT_O_DATA_2 : INTEGER := 16#30#;
    constant ADDR_RESULT_O_CTRL   : INTEGER := 16#34#;
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_result_i(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_result_i(63 downto 32) <= (others => '0');
            elsif (ACLK_EN = '1') then
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_result_i(95 downto 64) <= (others => '0');
            elsif (ACLK_EN = '1') then
