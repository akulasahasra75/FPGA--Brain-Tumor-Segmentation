...
entity otsu_threshold_top_control_r_s_axi is
generic (
...
end entity otsu_threshold_top_control_r_s_axi;
...
architecture behave of otsu_threshold_top_control_r_s_axi is
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_img_out(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_img_out(63 downto 32) <= (others => '0');
            elsif (ACLK_EN = '1') then
