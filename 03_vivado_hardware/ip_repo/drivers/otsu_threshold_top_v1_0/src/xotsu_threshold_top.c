...
void XOtsu_threshold_top_Set_result_i(XOtsu_threshold_top *InstancePtr, XOtsu_threshold_top_Result_i Data) {
    ...
    XOtsu_threshold_top_WriteReg(InstancePtr->Control_BaseAddress, XOTSU_THRESHOLD_TOP_CONTROL_ADDR_RESULT_I_DATA + 0, Data.word_0);
    XOtsu_threshold_top_WriteReg(InstancePtr->Control_BaseAddress, XOTSU_THRESHOLD_TOP_CONTROL_ADDR_RESULT_I_DATA + 4, Data.word_1);
    XOtsu_threshold_top_WriteReg(InstancePtr->Control_BaseAddress, XOTSU_THRESHOLD_TOP_CONTROL_ADDR_RESULT_I_DATA + 8, Data.word_2);
}

XOtsu_threshold_top_Result_i XOtsu_threshold_top_Get_result_i(XOtsu_threshold_top *InstancePtr) {
    XOtsu_threshold_top_Result_i Data;

    Data.word_0 = XOtsu_threshold_top_ReadReg(InstancePtr->Control_BaseAddress, XOTSU_THRESHOLD_TOP_CONTROL_ADDR_RESULT_I_DATA + 0);
    Data.word_1 = XOtsu_threshold_top_ReadReg(InstancePtr->Control_BaseAddress, XOTSU_THRESHOLD_TOP_CONTROL_ADDR_RESULT_I_DATA + 4);
    Data.word_2 = XOtsu_threshold_top_ReadReg(InstancePtr->Control_BaseAddress, XOTSU_THRESHOLD_TOP_CONTROL_ADDR_RESULT_I_DATA + 8);
    return Data;
}

XOtsu_threshold_top_Result_o XOtsu_threshold_top_Get_result_o(XOtsu_threshold_top *InstancePtr) {
    XOtsu_threshold_top_Result_o Data;

    Data.word_0 = XOtsu_threshold_top_ReadReg(InstancePtr->Control_BaseAddress, XOTSU_THRESHOLD_TOP_CONTROL_ADDR_RESULT_O_DATA + 0);
    Data.word_1 = XOtsu_threshold_top_ReadReg(InstancePtr->Control_BaseAddress, XOTSU_THRESHOLD_TOP_CONTROL_ADDR_RESULT_O_DATA + 4);
    Data.word_2 = XOtsu_threshold_top_ReadReg(InstancePtr->Control_BaseAddress, XOTSU_THRESHOLD_TOP_CONTROL_ADDR_RESULT_O_DATA + 8);
    return Data;
}
...
u32 XOtsu_threshold_top_Get_result_o_vld(XOtsu_threshold_top *InstancePtr) {
    ...
    Data = XOtsu_threshold_top_ReadReg(InstancePtr->Control_BaseAddress, XOTSU_THRESHOLD_TOP_CONTROL_ADDR_RESULT_O_CTRL);
    return Data & 0x1;
}
