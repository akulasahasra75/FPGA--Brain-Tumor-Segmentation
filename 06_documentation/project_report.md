...
**Target Board:** Digilent Basys 3 (Xilinx Artix-7 xc7a35tcpg236-1)  
...
- **Synthesis results:**  Target clock 10 ns (100 MHz), passed on xc7a35tcpg236-1
...
- **Constraints:** Basys 3 pin assignments (100 MHz clock, UART, 5 LEDs, reset button)
...
*Note: Exact values from Vitis HLS synthesis report. Full SoC utilisation will be higher.*
...
*Performance numbers are estimates based on HLS latency and typical Artix-7 power. Actual values require post-implementation measurement.*
...
2. Xilinx, *Vitis HLS User Guide (UG1399)*, v2025.1.
3. Xilinx, *MicroBlaze Processor Reference Guide (UG984)*.
4. Digilent, *Basys 3 Reference Manual*.
