...
This project implements a complete **brain tumor segmentation pipeline on an FPGA** (Artix-7, Basys 3 board). A grayscale MRI image is segmented using Otsu's thresholding (hardware-accelerated via Vitis HLS) followed by connected-component watershed analysis on a MicroBlaze soft-processor.
